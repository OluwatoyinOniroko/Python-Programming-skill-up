...
groceries_df = pd.read_csv("C:/Users/HP/OneDrive/Desktop/Ty  - Fall 2023/Programming/Datasets/groceriesArm.csv",header=None)
...
# generate freq item sets using support threshold min_support=0.009
freq_items = apriori(encoded_vals_df, min_support=0.009,use_colnames=True)

# get the rules with confidence threshold set to 0.58
rules = association_rules(freq_items, metric="confidence", min_threshold=0.58)
